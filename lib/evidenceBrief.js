...
function compactPipelineContext({ mode, parsed, evidence, triage, validation, conflictResolver, shadowCheck }) {
  return {
    ...
    instructions_to_composer: [
      ...
      'If shadow_check.enabled is true, include a concise Nexus Shadow Check section with Hidden risks, Missing/blind-spot data, Urgency changers, and Pharmacist traps. Do not repeat the whole answer; focus on what the user could miss.'
    ]
  };
}
