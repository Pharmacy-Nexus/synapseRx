...
function compactPipelineContext({ mode, parsed, evidence, triage, validation, conflictResolver, shadowCheck }) {
  return {
    ...
    instructions_to_composer: [
      ...
      'Use ONLY sources present in evidence.sources / matched interactions / matched clinical rules. Do not mention unrelated local rules such as warfarin, ACEI/ARB, or NSAID rules unless they were actually matched to this exact case.',
      'Case Fact Lock: do not invent or alter patient facts, lab values, timelines, doses, baseline values, or events. If a value was not provided, say it was not provided instead of guessing.',
